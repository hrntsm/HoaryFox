...
{
    public class Stb2ColumnSec:GH_Component
    {
        ...
        /// </summary>
        public Stb2ColumnSec()
          : base("StbtoColumnSectionTag", "S2ClSec", "Read ST-Bridge file and display Column Section Tag", "StbHopper", "Section")
        {
        }
